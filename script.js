function createTask(task) {
    ...
    template = template.replace('#members#', task.members.length).replaceAll('#bgcolor#',task.bgcolor)
...
let tasks = [
    ...
    {"icon":"emoji_emotions", "bgcolor":"green", "title":"Run 3 miles", "category":"Emotional","desc":"Run 3 miles every day","members":['img/avatar.jpg','img/avatar.jpg','img/avatar.jpg']},
    {"icon":"question_answer", "bgcolor":"yellow", "title":"Run 3 miles", "category":"Social","desc":"Run 3 miles every day","members":['img/avatar.jpg','img/avatar.jpg','img/avatar.jpg']},
]
